...
export const styles: Record<string, React.CSSProperties> = {
  ...
  textarea: { width: "100%", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 10, padding: "12px 14px", color: "#e7ecf3", fontSize: 15, fontFamily: "inherit", resize: "vertical" },
  ...
  ghostBtn: { background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.12)", color: "#e7ecf3", padding: "10px 18px", borderRadius: 999, fontSize: 13, cursor: "pointer", fontFamily: "inherit" },
  ...
  tab: { padding: "10px 18px", borderRadius: 999, fontSize: 13, cursor: "pointer", fontFamily: "inherit", background: "transparent", border: "1px solid rgba(255,255,255,0.08)", color: "#9aa6bd" },
  tabActive: { padding: "10px 18px", borderRadius: 999, fontSize: 13, cursor: "pointer", fontFamily: "inherit", background: "linear-gradient(135deg,#7fe3ff,#a78bfa)", border: "1px solid transparent", color: "#0b0e16", fontWeight: 600 },
};
